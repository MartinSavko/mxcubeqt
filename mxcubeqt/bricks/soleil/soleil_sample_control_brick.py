...
class SoleilSampleControlBrick(SampleControlBrick):
    ...
    def create_graphics_elements(self):
        ...
        self.visual_align_button = MonoStateButton(self, "VisualAlign", "Line")
        ...
        self.realign_button = MonoStateButton(self, "BeamCheck", "QuickRealign")
        self.anneal_button = MonoStateButton(self, "Anneal", "Snowflake")
        self.excenter_button = MonoStateButton(self, "XCenter", "xorg")
    ...
    def create_layout(self):
        ...
        _main_layout.addWidget(self.anneal_button)
        _main_layout.addWidget(self.excenter_button)
    ...
    def diffractometer_phase_changed(self, phase):
        ...
        self.realign_button.setEnabled(status)
